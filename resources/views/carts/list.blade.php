...
@section('content')
    ...
    <!-- Shoping Cart -->
    <form class="bg0 p-t-110 p-b-85" method="post">
        <div class="container">
            <div class="row">
                        ...
                        <div class="wrap-table-shopping-cart">
                            ...
                            <table class="table-shopping-cart">
                                ...
                                @foreach($products as $key => $product)
                                    ...
                                    $priceProduct = $price * $carts[$product->id];
//                                    dd($priceProduct);
                                    $total += $priceProduct;
                                    @endphp
                                    <tr class="table_row">
                                        <td class="column-1">
                                            <div class="how-itemcart1">
                                                <img src="{{ $product->thumn }}" alt="IMG">
                                            </div>
                                        </td>
                                        <td class="column-2">{{ $product->name }}</td>
                                        <td class="column-3">{{ $product->price_sale != 0 ? number_format($product->price_sale) : number_format($product->price) }}</td>
                                        <td class="column-4">
